...
namespace SampleApp.API.Controllers
{
    ...
    public class StudentController : UnSecureRepositoryController<IStudentRepository>
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AddFacility([FromBody]Student entity)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<IActionResult> UpdateFacility([FromBody]Student entity)
        {
            try
            {
